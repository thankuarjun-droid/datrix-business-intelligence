...
-- FIXED VERSION - Handles foreign key constraints
-- =====================================================

-- Step 1: Clear existing data in correct order (child tables first)
DELETE FROM public.assessment_responses;
DELETE FROM public.assessments;
DELETE FROM public.industry_benchmarks;  -- Delete benchmarks first (references categories)
